...
#define CONFIG_PREBOOT	"echo;"	\
	...
	"echo"
#define CONFIG_BOOTCOMMAND	"run flyer"
...
#define CONFIG_AMCC_DEF_ENV_ROOTPATH	"rootpath=/home/mh1/tftpboot/rootfs\0"
#else
...
#define CONFIG_AMCC_DEF_ENV_PPC						\
	...
	"net_nfs=tftp 200000 ${bootfile};"				\
		"run nfsargs addip addtty addmem;"			\
		"bootm ${kernel_addr}\0"
...
#define CONFIG_AMCC_DEF_ENV_NOR_UPD					\
	"load=tftp 200000 /flyer3d/u-boot.bin\0"	\
